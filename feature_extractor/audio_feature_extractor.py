import os
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3" # set gpu number
import numpy as np
...
audio_dir = "audio/" # .wav audio files
...
for n in range(len_data):
    ...
    with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
        vggish_slim2.define_vggish_slim()
        vggish_slim2.load_vggish_slim_checkpoint(sess, checkpoint_path)
        ...
        print(embedding_batch.shape) #(10,128)
