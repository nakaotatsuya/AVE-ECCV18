...
parser.add_argument('--dir_video', type=str, default="feature_extractor/pict_cnn_feature.h5",
                    help='visual features')
parser.add_argument('--dir_audio', type=str,
                    default='feature_extractor/audio_embedding.h5',
                    help='audio features')
parser.add_argument('--dir_labels', type=str, default='feature_extractor/labels.h5',
                    help='labels of AVE dataset')

parser.add_argument('--dir_order_train', type=str, default='feature_extractor/train_order.h5',
                    help='indices of training samples')
parser.add_argument('--dir_order_val', type=str, default='feature_extractor/val_order.h5',
                    help='indices of validation samples')
parser.add_argument('--dir_order_test', type=str, default='feature_extractor/test_order.h5',
...
def train(args):
    #AVEData = AVEDataset(video_dir=args.dir_video, audio_dir=args.dir_audio, label_dir=args.dir_labels,order_dir=args.dir_order_train, batch_size=args.batch_size)
    AVEData = Dataset(video_dir=args.dir_video, audio_dir=args.dir_audio, label_dir=args.dir_labels, order_dir=args.dir_order_test, batch_size=args.batch_size)
...
def val(args):
    net_model.eval()
    #AVEData = AVEDataset(video_dir=args.dir_video, audio_dir=args.dir_audio, label_dir=args.dir_labels,order_dir=args.dir_order_val, batch_size=402)
    AVEData = Dataset(video_dir=args.dir_video, audio_dir=args.dir_audio, label_dir=args.dir_labels, order_dir=args.dir_order_test, batch_size=57)
